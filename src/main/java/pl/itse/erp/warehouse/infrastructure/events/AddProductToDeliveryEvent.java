...
public class AddProductToDeliveryEvent implements DomainEvent {
    ...
    public AddProductToDeliveryEvent(BaseEntity aggregate, String data, EventStore.ActionType actionType, Date eventCreated) {
