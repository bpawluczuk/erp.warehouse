...
public class UpdateProductEvent implements DomainEvent {
    ...
    public UpdateProductEvent(BaseEntity aggregate, String data, EventStore.ActionType actionType, Date eventCreated) {
