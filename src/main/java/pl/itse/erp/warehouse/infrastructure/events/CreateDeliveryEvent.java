...
public class CreateDeliveryEvent implements DomainEvent {
    ...
    public CreateDeliveryEvent(BaseEntity aggregate, String data, EventStore.ActionType actionType, Date eventCreated) {
