...
public class AddProductToReleaseEvent implements DomainEvent {
    ...
    public AddProductToReleaseEvent(BaseEntity aggregate, String data, EventStore.ActionType actionType, Date eventCreated) {
