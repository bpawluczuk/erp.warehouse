...
public class CreateReleaseEvent implements DomainEvent {
    ...
    public CreateReleaseEvent(BaseEntity aggregate, String data, EventStore.ActionType actionType, Date eventCreated) {
